...
export default function FeaturesPage() {
  return (
    <div className="min-h-screen bg-background text-foreground transition-colors duration-300 font-inter flex flex-col justify-between">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 group">
            <svg viewBox="0 0 32 32" className="w-8 h-8 select-none">
              <defs>
                <linearGradient id="logo-grad-feat" x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      {/* Main Content */}
      <main className="relative flex-1 flex flex-col items-center justify-center p-6 text-center overflow-hidden">
        ...
        <div className="max-w-md bg-card border border-border/50 rounded-card shadow-card p-8 sm:p-10 relative z-10 flex flex-col items-center gap-6">
          ...
          <div className="space-y-2">
            ...
            <p className="font-inter text-sm text-muted-foreground leading-relaxed">
              Our advanced AI commerce auto-reply capability is under active development. Complete platform features and specifications will be available soon.
            </p>
          </div>
