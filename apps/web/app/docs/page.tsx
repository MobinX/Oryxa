        ...
        <div className="max-w-md bg-card border border-border/50 rounded-card shadow-card p-8 sm:p-10 relative z-10 flex flex-col items-center gap-6">
          ...
          <div className="space-y-2">
            ...
            <p className="font-inter text-sm text-muted-foreground leading-relaxed">
              Step-by-step guides, onboarding walk-throughs, and tutorials on connecting WhatsApp, Instagram and Facebook. Documentation engine coming soon.
            </p>
          </div>
